...
padding-left:50px;
   ...
   <fieldset>
         ...
         <form method="post" action='Press/controller/search.php'>
...
<input type="radio" name="ser" value="state">State<br/>
        ...
        <p><form action="Press/controller/sort.php" method="post" >
sort 
...
<input type="submit" value="Filter">
         ...
         require './Press/Model/release_repository.php';
...
<?php } 
 Print "</table>";?>
        ...
        <div id="sidebar">
              <h1>Login</h1>
              <form action="Press/controller/LoginCon.php" method="post" id="login_form">
